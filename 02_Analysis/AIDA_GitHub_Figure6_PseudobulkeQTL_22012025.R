### AIDA Phase 1 Data Freeze v1 pseudobulk eQTL analysis: version 22 January 2025
### Example workflow for B cell subtypes - change vector of cell subtypes to cell population of interest
...
##### USER INPUT: change vec_celltypes_of_interest to subtypes of the cell population of interest #####
### Here we have examples of B cell subtypes
...
vec_celltypes_of_interest = c("naive_B", "IGHMhi_memory_B", "IGHMlo_memory_B", "atypical_B")
...
for (str_subtype in vec_celltypes_of_interest){
  ...
  ### Checking df_expression column names are in same order as df_covariate row names
